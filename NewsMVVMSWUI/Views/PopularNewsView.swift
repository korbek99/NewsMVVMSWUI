...
struct PopularNewsView: View {
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                if viewModel.isLoading {
                    ...
                    List(viewModel.filteredArticles) { article in
                        NavigationLink(destination: DetailsNewsView(article: article)) {
            ...
            .searchable(text: $viewModel.searchText, prompt: "Buscar noticias...")
            .onAppear {
...
extension String {
    func formatDate() -> String {
        ...
        outputFormatter.locale = Locale(identifier: "es_ES") // Opcional: Forzar español
